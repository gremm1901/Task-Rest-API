namespace AutotestAPI
{
    ...
    public static class AssertionHelper
    {
        ...
        public static void CheckParametrUserPFS(UserPFSResponse requst, UserPFSResponse client)
        {
        ...
        public static void CheckErrorMessegPS(AnswerPSResponse requst, int code, string type, string message)
        {
