namespace AutotestAPI
{
    public class PlatziFakeStoreClient
    {
        ...
        /// <returns></returns>
        public RestResponse<List<CreateUserResponse>> GetUsers(int limit) 
        {
            var req = new RestRequest($"api/v1/users?limit={limit}", Method.Get);
            return _client.Execute<List<CreateUserResponse>>(req);
        }
        /// <summary>
        /// Создать клиента
        /// </summary>
        ...
        /// <returns></returns>
        public RestResponse<CreateUserResponse> CreateUsers(CreateUserPlatziFakeStoreRequest body)
        {
            var req = new RestRequest("api/v1/users", Method.Post);
            req.AddJsonBody(body);
            return _client.Execute<CreateUserResponse>(req);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public RestResponse<CreateUserResponse> GetUsersId(int id)
        {
        ...
        /// <param name="id">Id клиента</param>
        /// <returns></returns>
        public RestResponse<CreateUserResponse> PutUserId(CreateUserPlatziFakeStoreRequest body, int id)
        {
        ...
        /// <param name="id">Id клиента</param>
        /// <returns></returns>
        public RestResponse<CreateUserResponse> DeleteUsersId(int id)
        {
        ...
        /// <returns></returns>
        public RestResponse<IsAvailableUserReaponse> IsAvailableUser(IsAvailableUserRequest body)
        {
        ...
        /// <returns></returns>
        public RestResponse<CreateUserResponse> GetProfileUser(string token) 
        {
        ...
        /// <returns></returns>
        public RestResponse<CreateProductRequest> CreateProduct(CreateUserPlatziFakeStoreRequest body)
        {
        ...
        /// <param name="id">Id категории</param>
        /// <returns></returns>
        public RestResponse<ErrorPlatziFakeStoreRespose> DeleteCategoriesId(int id)
        {
            var req = new RestRequest($"api/v1/categories/{id}", Method.Delete);
            return _client.Execute<ErrorPlatziFakeStoreRespose>(req);
        }
    }
}
